          ...
          <div className="ContactUs__wrap">
            ...
            <MDBContainer>
              ...
              <MDBModal isOpen={this.state.modal} toggle={this.secondToggle}>
                <MDBModalHeader toggle={this.secondToggle} className="grey-text">
                  <h3>Місце знаходження</h3>
                </MDBModalHeader>
                <MDBModalBody>
                  <Iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d647.5346386688045!2d24.399468829245123!3d49.51965986933781!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDnCsDMxJzEwLjgiTiAyNMKwMjQnMDAuMSJF!5e0!3m2!1sru!2sua!4v1591639847902!5m2!1sru!2sua" width="340" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" />
                </MDBModalBody>
                <MDBModalFooter>
